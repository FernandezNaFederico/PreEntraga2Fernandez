...
const menu1 = new menu  (
    "Flint Loco",
    "Medallon de Carne, Cebolla Caramelizada, Bacon, Cheddar, Tomates Asados, Barbacoa, Salsa Golf",
    "$ 2500",
);

const menu2 = new menu (
    "Beby Brent",
    "Medallon de Pollo, Tomate, Lechuga, Queso Provolone, Mayonesa, Salsa Cheddar",
    "$2300",
);

const menu3 = new menu (
    "FLDSMDFR",
    "Medallon de Soja, Queso Azul, Muzzarella, Tomate Cherry, Albaca, Queso Parmesano" ,
    "$2000",
);*/